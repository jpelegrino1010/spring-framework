package com.julioluis.easyschool.aspect;
...
public class LoggerAspect {
    ...
    @Around("execution(* com.julioluis.easyschool.*.*(..))")
    ...
    @AfterThrowing(value = "execution(* com.julioluis.easyschool.*.*(..))",throwing = "ex")
    ...
    @AfterReturning(value = "execution(* com.julioluis.easyschool.*.*(..))",returning = "retVal")
