...
public class LoggerAspect {
    ...
    @Around("execution(* com.julioluis.services.*.*(..))")
    ...
    @AfterThrowing(value = "execution(* com.julioluis.services.*.*(..))",throwing = "ex")
    ...
    @AfterReturning(value = "execution(* com.julioluis.services.*.*(..))",returning = "retVal")
